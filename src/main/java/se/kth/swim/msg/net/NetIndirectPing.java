...
public class NetIndirectPing extends NetMsg<IndirectPing> {
  ...
  public NetIndirectPing(NatedAddress source, NatedAddress destination, Peer suspected, UUID pingTimeout) {
    super(source, destination, new IndirectPing(suspected, pingTimeout));
  }
